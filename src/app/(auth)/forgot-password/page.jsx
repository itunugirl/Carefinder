...
var ForgotPasswordPage = function () {
    ...
    var handlePasswordReset = function (e) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, auth_1.sendPasswordResetEmail)(index_1.auth, email)];
                case 2:
                    _a.sent();
                    setSuccess('Password reset email sent! Check your inbox.');
                    setError(null);
                    setEmail('');
                    setTimeout(function () { return router.push('/login'); }, 3000); // Redirect to login after 3 seconds
                    return [3 /*break*/, 5];
                case 3:
                    error_1 = _a.sent();
