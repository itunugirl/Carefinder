    ...
    <>
      ...
      >
        <section className="bg-white bg-opacity-90 rounded-lg shadow-xl max-w-3xl w-full p-8 mb-12">
          <h1 className="text-4xl font-extrabold text-blue-800 mb-4 text-center">Find Your Nearest Hospitals</h1>
        ...
        {results.length > 0 && (
          <section className="w-full relative">
            ...
            {filteredResults.length > 0 ? (
              ...
              !loading && !message && <p className="text-center text-gray-600">No hospitals found. Try adjusting your search criteria.</p>
            )}
          </section>
        )}
      </main>
