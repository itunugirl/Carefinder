      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden transform transition-transform hover:scale-105">
            ...
            />
            <div className="p-6">
              <h2 className="text-xl md:text-2xl font-semibold text-blue-800 mb-4">Comprehensive Health Assessments</h2>
              ...
              <button 
                ...
                className="inline-block text-blue-600 hover:text-blue-800 font-semibold transition-colors text-base md:text-lg"
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden transform transition-transform hover:scale-105">
            ...
            />
            <div className="p-6">
              <h2 className="text-xl md:text-2xl font-semibold text-blue-800 mb-4">Personalized Wellness Programs</h2>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden transform transition-transform hover:scale-105">
            ...
            />
            <div className="p-6">
              <h2 className="text-xl md:text-2xl font-semibold text-blue-800 mb-4">Expert Consultations</h2>
